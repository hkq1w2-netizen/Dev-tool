...
export const metadata = generateSeoMetadata({
  ...
  description: "DevTools.online Privacy Policy explaining client-side browser processing and data handling commitments.",
  path: "/privacy",
});
  ...
  return (
    <div className="max-w-3xl mx-auto space-y-6 py-6 text-gray-700 dark:text-gray-300 text-sm leading-relaxed">
      ...
      <section className="space-y-3 pt-4 border-t border-gray-200 dark:border-gray-800">
        ...
        <p>
          DevTools.online is designed to prioritize your privacy. All developer tool operations (including JSON formatting, Base64 encoding/decoding, Regular Expression testing, UUID generation, HTML/CSS formatting, and timestamp conversions) are processed 100% locally inside your Web browser.
        </p>
        <p>
      ...
      <section className="space-y-3">
        ...
        <p>
          When you register a free or Pro account, we store your name, email address, password hash (encrypted using bcrypt), and subscription status securely in our database. We do not sell or rent your user account information to third parties.
        </p>
      </section>
